...
<html>
  ...
  <body>
    <div class="container">
      ...
      <p>Su cita ha sido reservada. Los detalles de su cita son los siguientes:</p>
      <ul>
        <strong><li>Fecha: {{ $created_appointment->schedule_date }} </li></strong>
        <strong><li>Hora: {{ $created_appointment->schedule_time }} </li></strong>
