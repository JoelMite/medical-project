                            ...
                            <div class="form-group">
                                <div class="form-group" id="boton-collapse-2">
                                    <button class="btn btn-warning btn-lg btn-block text-left collapsed" type="button"
                                        ...
                                        aria-controls="contenido-btn-2">Datos de Usuario
                                        <i class="ni ni-check-bold text-white"></i></button>
                                </div>
                                <!-- Contenedor -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="password" class="form-control"
                                                        placeholder="******" value="{{ Str::random(6) }}" required>
                                                    <div class="invalid-feedback">Este campo es obligatorio.</div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control selectpicker" name="specialties[]"
                                                        ...
                                                        <option value="{{ $specialty->id }}" {{
                                                            ...
                                                            contains($specialty->id)) ? 'selected':'' }}>{{
                                                            $specialty->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                            ...
                            <div class="form-group">
                                <div class="form-group" id="boton-collapse-3">
                                    <button class="btn btn-primary btn-lg btn-block text-left collapsed" type="button"
                                        ...
                                        aria-controls="contenido-btn-3">Datos Adicionales
                                        <i class="ni ni-check-bold text-white"></i></button>
                                </div>
                                <!-- Contenedor -->
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control selectpicker" name="etnia" id="etnia"
                                                        ...
                                                        <option value="Afroamericano" @if(old('etnia')=="Afroamericano"
                                                            ) selected @endif>Afroamericano</option>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control selectpicker" name="roles[]" id="roles"
                                                        data-style="btn-primary text-white" multiple
                                                        title="Seleccione uno o varios roles" required>
                                                        @foreach ($roles as $role)
                                                        <option value="{{ $role->id }}" {{ (collect(old('roles'))->
                                                            contains($role->id)) ? 'selected':'' }}>{{ $role->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback">Este campo es obligatorio.</div>
