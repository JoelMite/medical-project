        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('clinic_histories/'.$histories->id)}}" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="personal_history" class="form-control"
                                        value="{{ old('personal_history', $histories->personal_history) }}" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="family_background" class="form-control"
                                        value="{{ old('family_background', $histories->family_background) }}" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="current_illness" class="form-control"
                                        value="{{ old('current_illness', $histories->current_illness) }}" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="habits" class="form-control" value="{{ old('current_illness', $histories->habits) }}"
                                        required></textarea>
                                </div>
                            </div>
