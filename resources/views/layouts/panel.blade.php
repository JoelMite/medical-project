...
<head>
  ...
  <link href=" {{ asset('assets/bundles/owlcarousel2/dist/assets/owl.carousel.min.css') }}" rel="stylesheet">
  <link href=" {{ asset('assets/bundles/owlcarousel2/dist/assets/owl.theme.default.min.css') }}" rel="stylesheet">
  ...
  <link href=" {{ asset('assets/bundles/select2/dist/css/select2.min.css') }}" rel="stylesheet"> --}}
